...
def tokenization(txt):
    tokens = nltk.word_tokenize(txt) #tách thành các từ riêng lẻ để dễ dàng xử lí
    #xóa bỏ các từ không cần thiết như "and" , "the" sau đó đưa về dạng gốc ví dụ training -> train
